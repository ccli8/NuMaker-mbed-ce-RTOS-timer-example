# Example for RTOS basic on Nuvoton's Mbed CE enabled boards

This is an example to demo RTOS timer APIs on Nuvoton's Mbed CE enabled boards.
...
1.  Clone the example and navigate into it
    ```
    $ git clone https://github.com/mbed-nuvoton/NuMaker-mbed-ce-RTOS-timer-example
    $ cd NuMaker-mbed-ce-RTOS-timer-example
...
Flash by drag-n-drop built image `NuMaker-mbed-ce-RTOS-timer-example.bin` or `NuMaker-mbed-ce-RTOS-timer-example.hex` onto **NuMaker-IoT-M467** board

### Verify the result

Press device's reset button to execute, LED1, LED2, and LED3 will flash on.
